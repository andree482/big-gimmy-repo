                      ...
                      <div className="flex items-center justify-between">
                        <div>
                          {(() => {
                            ...
                            const priceFromCents = product.min_price_cents || product.minPriceCents;
                            const priceFromBase = product.basePrice || product.base_price;
                            const priceFromField = product.price;
                            
                            let displayPrice = 0;
                            
                            // Priority: min_price_cents > basePrice > price
                            if (priceFromCents && priceFromCents > 0) {
                              displayPrice = priceFromCents / 100;
                            } else if (priceFromBase && priceFromBase > 0) {
                              displayPrice = priceFromBase > 100 ? (priceFromBase / 100) : priceFromBase;
                            } else if (priceFromField && priceFromField > 0) {
                              displayPrice = priceFromField > 100 ? (priceFromField / 100) : priceFromField;
                            }
