        ...
        <div className="md:hidden">
          <div className="mb-8">
            ...
            <div className="flex justify-center space-x-6">
              <a href="https://www.facebook.com/p/BIG-GIMMY-Integratori-100063525402348/" target="_blank" rel="noopener noreferrer" className="text-white hover:text-[#FFD100] transition-all">
                <Facebook className="h-6 w-6" />
              </a>
              <a href="https://www.instagram.com/biggimmyintegratori/" target="_blank" rel="noopener noreferrer" className="text-white hover:text-[#FFD100] transition-all">
          ...
          <div className="mb-6 pb-6 border-b border-gray-800">
            <h4 className="font-montserrat font-semibold text-base mb-3 text-[#FFD100] text-center">Collegamenti Rapidi</h4>
        ...
        <div className="hidden md:grid md:grid-cols-4 gap-8">
          <div>
            ...
            <div className="flex space-x-4">
              ...
              <a href="#" className="text-white hover:text-[#FFD100] transition-all">
          ...
          <div>
            <h4 className="font-montserrat font-semibold text-lg mb-4 text-[#FFD100]">Collegamenti Rapidi</h4>
          ...
          <div>
            <h4 className="font-montserrat font-semibold text-lg mb-4 text-[#FFD100]">Categorie Prodotti</h4>
            <ul className="space-y-2">
          ...
          <div>
            <h4 className="font-montserrat font-semibold text-lg mb-4 text-[#FFD100]">Seguici sui Social</h4>
